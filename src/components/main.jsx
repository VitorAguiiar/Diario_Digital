...
import Lixeira from '../assets/image/lixeira.svg';
      ...
      <div className="flex justify-between items-center mb-4">
        <div className="relative w-3/5 ml-[54px] mr-[10px]">
          <input
            ...
            className="w-full p-2 pr-10 bg-white rounded-full text-sm placeholder-opacity-25 placeholder-gray-700 pl-4 focus:ring-2 focus:ring-blue-500 focus:outline-none"
          />
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            className="flex items-center justify-center p-2 rounded min-w-[40px] bg-[#DB4060] hover:bg-[#DB4060] transition-colors"
          >
            <img className="w-6 h-6" src={Lixeira} alt="Excluir" />
          </button>
